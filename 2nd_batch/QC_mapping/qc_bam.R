...
csvfile <- read.csv("/groups/dog/stage/rahma/2nd_batch/results/minimap2/qc_mapping.csv", header=FALSE)
...
ggsave("/groups/dog/stage/rahma/2nd_batch/results/minimap2/qc_mapping_2ndbatch.pdf", plot, width = 12, height = 7)
